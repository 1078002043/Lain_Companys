...
public class CircleProgress extends View {
    ...
    protected void initViewSize() {
        ...
        if (useGradient) {
            ...
            //报警时的画笔渐变
            LinearGradient gradient2 = new LinearGradient(0, 0, mWidth, mHeight, Color.parseColor("#DC143C"), Color.RED, Shader.TileMode.CLAMP);
            alertPaint.setShader(gradient2);
    ...
    protected void initForePaint() {
        ...
        setCommonPaint(alertPaint, isSolid, isCircleCorner);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //如果处于报警状态，则使用红色画笔，反之正常颜色画笔
        if (currProgress == maxProgress) {
            canvas.drawArc(mPaintRectF, 0, currProgress, isSolid, alertPaint);
        } else {
