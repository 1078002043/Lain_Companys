...
public class TickCircleProgress extends CircleProgress {
    ...
    public void setValue(double value) {
        ...
        double start = currProgress;
        double end = value / maxProgress;

        startAnimator((float)start, (float)end, 3000);
    }
...
////                Log.d("kljklfgf", "onAnimationUpdate: " + mValue + "---" + mPercent + "---" + mMaxValue);
