...
public class CentralAirBean {
    ...
    public static CentralAirBean objectFromData(String str) {

        return new Gson().fromJson(str, CentralAirBean.class);
    }

    public static CentralAirBean objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), CentralAirBean.class);
    ...
    public static List<CentralAirBean> arrayCentralAirBeanFromData(String str) {

        Type listType = new TypeToken<ArrayList<CentralAirBean>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<CentralAirBean> arrayCentralAirBeanFromData(String str, String key) {
    ...
    public static class MalfunctionPojoBean {
        ...
        public static MalfunctionPojoBean objectFromData(String str) {

            return new Gson().fromJson(str, MalfunctionPojoBean.class);
        }

        public static MalfunctionPojoBean objectFromData(String str, String key) {

            try {
                JSONObject jsonObject = new JSONObject(str);

                return new Gson().fromJson(jsonObject.getString(str), MalfunctionPojoBean.class);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        ...
        public static List<MalfunctionPojoBean> arrayMalfunctionPojoBeanFromData(String str) {

            Type listType = new TypeToken<ArrayList<MalfunctionPojoBean>>() {
            }.getType();

            return new Gson().fromJson(str, listType);
        }

        public static List<MalfunctionPojoBean> arrayMalfunctionPojoBeanFromData(String str, String key) {
    ...
    public static class ParameterPojoBean {
        ...
        public static ParameterPojoBean objectFromData(String str) {

            return new Gson().fromJson(str, ParameterPojoBean.class);
        }

        public static ParameterPojoBean objectFromData(String str, String key) {

            try {
                JSONObject jsonObject = new JSONObject(str);

                return new Gson().fromJson(jsonObject.getString(str), ParameterPojoBean.class);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        ...
        public static List<ParameterPojoBean> arrayParameterPojoBeanFromData(String str) {

            Type listType = new TypeToken<ArrayList<ParameterPojoBean>>() {
            }.getType();

            return new Gson().fromJson(str, listType);
        }

        public static List<ParameterPojoBean> arrayParameterPojoBeanFromData(String str, String key) {
    ...
    public static class SetConditionPojoBean {
        ...
        public static SetConditionPojoBean objectFromData(String str) {

            return new Gson().fromJson(str, SetConditionPojoBean.class);
        }

        public static SetConditionPojoBean objectFromData(String str, String key) {

            try {
                JSONObject jsonObject = new JSONObject(str);

                return new Gson().fromJson(jsonObject.getString(str), SetConditionPojoBean.class);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        ...
        public static List<SetConditionPojoBean> arraySetConditionPojoBeanFromData(String str) {

            Type listType = new TypeToken<ArrayList<SetConditionPojoBean>>() {
            }.getType();

            return new Gson().fromJson(str, listType);
        }

        public static List<SetConditionPojoBean> arraySetConditionPojoBeanFromData(String str, String key) {
