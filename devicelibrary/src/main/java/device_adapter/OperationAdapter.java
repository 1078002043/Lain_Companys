 ...
 * @Time 2019/8/7 23 : 11
 */
public class OperationAdapter extends BaseRecyclerViewAdapter<ConfigBean> {
     ...
     */
    public OperationAdapter(Context context, List<ConfigBean> dataList, int layoutId) {
    ...
    protected void bindData(BaseViewHolder holder, ConfigBean data, int position) {
        ...
        //卡片
        LinearLayout cardView = holder.getView(R.id.environmental_card4);
        //设备图标
