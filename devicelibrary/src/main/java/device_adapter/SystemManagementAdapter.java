 ...
 * @Time 2019/8/7 23 : 49
 */
public class SystemManagementAdapter extends BaseRecyclerViewAdapter<ConfigBean> {
    Context context;
     ...
     */
    public SystemManagementAdapter(Context context, List<ConfigBean> dataList, int layoutId) {
    ...
    protected void bindData(BaseViewHolder holder, ConfigBean data, int position) {
        ...
        Uri url = null;
        //卡片
        LinearLayout cardView = holder.getView(R.id.environmental_card5);
        //设备名称
