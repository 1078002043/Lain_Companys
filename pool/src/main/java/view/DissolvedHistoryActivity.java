 ...
 * 溶氧仪
 */
public class DissolvedHistoryActivity extends Lain_Base_Activity implements MarkerViewListener {
    ...
    public int setLayoutView() {
        return com.example.base.R.layout.device_history_activity;
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayLists.add(a2);
        //绑定曲线的控件
        final LineChart lineChart = findViewById(com.example.base.R.id.chart1_333);
        //获取单位
    ...
    public List<Integer> getLineChartColor() {
        ...
        colors.add(com.example.base.R.drawable.fade_blue);
        colors.add(com.example.base.R.drawable.fade_red);
