 ...
 * 水温检测
 */
public class WaterTempFragment extends Device8060Fragment<WaterTempRealBean, WaterTempAlertBean,
...
//    public Temperature_Add deviceDetail_AddAdapter;
     ...
     */
    public WaterTempFragment(String realLink, String alertLink, String historyLink, String manageLink) {
        super(realLink, alertLink, historyLink, manageLink);
    }

    public WaterTempFragment(String realLink, String alertLink, String historyLink, String manageLink, String deleteUrl, String changeUrl) {
        super(realLink, alertLink, historyLink, manageLink);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //Present
        waterTempPresent = new WaterTempPresent(this);
